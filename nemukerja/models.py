...
class User(db.Model, UserMixin):
    ...
    password_hash = db.Column(db.String(255), nullable=False) # CHANGED
...
class JobListing(db.Model):
    ...
    slots = db.Column(db.Integer, nullable=False, default=1) # ADDED
    is_open = db.Column(db.Boolean, nullable=False, default=True) # ADDED
